        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <div className="w-24 h-1 bg-emerald-500 mx-auto rounded-full"></div>
              <p className="mt-6 text-blue-800 text-lg">
                Interested in booking or learning more? Contact our experts
                today.
              </p>
            </div>
          </FadeIn>
            ...
            <FadeIn direction="left" delay={0.2}>
              <div className="h-full w-full min-h-[400px] bg-stone-200 relative">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112615.15545927513!2d77.62539095!3d27.9472305!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3973551fb2db433f%3A0xe54260d5b4a68ef6!2sBajna%2C%20Uttar%20Pradesh%20281201!5e0!3m2!1sen!2sin!4v1710000000000!5m2!1sen!2sin"
